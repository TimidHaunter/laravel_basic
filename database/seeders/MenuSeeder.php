        ...
        $menus = [
            [
                ...
                'children' => [
                    ...
                    ['name' => '用户添加', 'group' => 'menu', 'level' => 2],
                    ['name' => '用户锁定', 'group' => 'menu', 'level' => 2],
                    ['name' => '用户注销', 'group' => 'menu', 'level' => 2],
                ]
            ],
            [
                'name' => '商品管理',
                ...
                'children' => [
                    ...
                    ['name' => '商品添加', 'group' => 'menu', 'level' => 2],
                    ['name' => '商品锁定', 'group' => 'menu', 'level' => 2],
                    ['name' => '商品下架', 'group' => 'menu', 'level' => 2],
                ]
            ],
            [
                'name' => '评价管理',
                ...
                'pid' => 0,
                'children' => [
                    ['name' => '评价列表', 'group' => 'menu', 'level' => 2],
                    ['name' => '评价回复', 'group' => 'menu', 'level' => 2],
                ]
            ]
        ];
